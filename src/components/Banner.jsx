...
const Banner = () => {
  return (
    <div className="bg-[url('/assets/banner.png')] text-white  flex justify-between flex-col items-center  gap-5 h-100">
      <div className=" text-center flex justify-center flex-col items-center gap-3.5 flex-1">
